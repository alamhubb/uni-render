...
┌─────────────────────────────────────────────────────────────────┐
│                    vite-plugin-mp                                │
│  1. 配置 alias: vue → uniapp-vue/compat                         │
...
| **Vite alias** | `vue → uniapp-vue/compat` 无侵入式劫持 |
...
import { createMpApp, createPageHandlers } from 'uniapp-vue'
