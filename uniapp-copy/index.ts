...
// ============================================
// 导出 Vue 所有 API
// 直接从 'vue' 导入，让宿主环境（UniApp）决定使用哪个 Vue 实现
// ============================================
export * from 'vue'
...
export function onLaunch(callback?: Function): void {
    console.log('[uniapp-render] onLaunch registered')
...
export function onShow(callback?: Function): void {
    console.log('[uniapp-render] onShow registered')
    if (typeof callback === 'function') {
        setTimeout(() => callback(), 0)
    }
}
...
export function onHide(callback?: Function): void {
    console.log('[uniapp-render] onHide registered')
}
...
console.log('[uniapp-render] 已加载 - Custom Renderer 模式')
